<?php
	...
	if(isset($_POST["from"])){
		...
		$res2 = $mysqli->query("select * FROM `dht11_test` WHERE `ID` >= $from and `ID` <= $to");
		$items = array();
		while( $rs = mysqli_fetch_row($res2) ) {
			$items[] = $rs;
		}
		
		$res3 = $mysqli->query("DELETE FROM `dht11_test` WHERE `ID` >= $from and `ID` <= $to");
                                        ...
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
												<table>
													...
													?>
													<tr>
														<td style="padding: 5px 10px 5px 5px;"><?php echo end($show)[1];?></td>
														<td></td>
														<td style="padding: 5px 10px 5px 100px;"><?php echo end($show)[2];?></td>
														<!--
